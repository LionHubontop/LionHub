...
NotificationLibrary:SendNotification("Warning", "Nhìn cái gì lo dùng Lion Hub cực múp đi", 10)
-- join team
...
getgenv().ToTargets = function(p)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.AutoFarm or _G.Tweenfruit or _G.Auto_Dungeon or _G.Kill_V4 or _G.AutoQuestRace or _G.RaDaoKhi or _G.Luom_Gear or _G.DaoBiLon or _G.BayDao or _G.Eli_Ngu or _G.Long_Ma_Bac_Giang or _G.Gan_Duoc_Cho_Khi or _G.AutoEctoplasm or _G.Kiem_Lua or Auto_Ki_Di or _G.Khi_Dot_Len_Dien or _G.AutoMaterial or _G.Quest_Nhu_Cai_Lon or _G.Katakuri_V2_Nhu_lon or _G.Auto_Nha_Dien or _G.Cuttay or _G.ThangDauMatLon or Gan_Haki_Lon or _G.HaiCac or _G.Shanda or BatDauKaitun or _TerroSharkVaPirranhaOMG or _G.Zone6 or _G.TeleportPly or _G.RaidPirate or _G.Raidlaw or StartFarm or FarmMasGun or _G.Chest or _G.Buoi == true then
    ...
    spawn(function()
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoFarm or _G.Tweenfruit or _G.Auto_Dungeon or _G.Kill_V4 or _G.AutoQuestRace or _G.RaDaoKhi or _G.Luom_Gear or _G.DaoBiLon or _G.BayDao or _G.Eli_Ngu or _G.Long_Ma_Bac_Giang or _G.Gan_Duoc_Cho_Khi or _G.AutoEctoplasm or _G.Kiem_Lua or Auto_Ki_Di or _G.Khi_Dot_Len_Dien or _G.Quest_Nhu_Cai_Lon or _G.Katakuri_V2_Nhu_lon or _G.Auto_Nha_Dien or _G.AutoMaterial or _G.Cuttay or _G.ThangDauMatLon or Gan_Haki_Lon or _G.HaiCac or _G.Shanda or BatDauKaitun or _TerroSharkVaPirranhaOMG or _G.Zone6 or _G.TeleportPly or _G.RaidPirate or _G.Raidlaw or StartFarm or FarmMasGun or _G.Chest or _G.Buoi == true then
...
SelectedFastAttackMode = {"Normal Attack","Fast Attack","NHM Fast"}
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "NHM Fast" then
		FireCooldown = 0.02
	end
end
...
local ToggleFarm = Tabs.Main:AddToggle("Start Farm", { Title = "Start Farm", Description = "Bắt Đầu Farm", Default = false })
Toggle:OnChanged(function(Value)
    _G.AutoFarm = Value
...
local Toggle = Tabs.af:AddToggle("Auto Stop", { Title = "Stop If Have key", Default = false })
Toggle:OnChanged(function(vu)
	Grab_Chest = vu
...
local Toggle = Tabs.Raid:AddToggle("Start Raid", { Title = "Start Raid", Default = false })
Toggle:OnChanged(function(Value)
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get fruit inventory under 1m",Description = "", Default = false })
...
local Section = Tabs.Raid:AddSection("Fruit")

local ToggleRandomFruit = Tabs.Raid:AddToggle("ToggleRandomFruit", {Title = "Random Fruit",Description = "", Default = false })
